...
export default async function MoviesPage() {
  try {
    ...
    if (!movies || movies.length === 0) {
      return <p>Не удалось загрузить фильмы или список пуст.</p>;
    }
    ...
    return <p className="text-red-500 text-center mt-10">Ошибка загрузки фильмов. Пожалуйста, попробуйте позже.</p>;
  }
}